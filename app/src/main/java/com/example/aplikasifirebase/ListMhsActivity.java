...
public class ListMhsActivity extends AppCompatActivity {
    List<com.example.aplikasifirebase.Mahasiswa> fetchData;
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    com.example.aplikasifirebase.Mahasiswa data = new com.example.aplikasifirebase.Mahasiswa(nim,nama);
                    fetchData.add(data);
                ...
                myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        startActivity(new Intent(ListMhsActivity.this, com.example.aplikasifirebase.EditMhsActivity.class).putExtra("nim",nim));
                    }
                });
