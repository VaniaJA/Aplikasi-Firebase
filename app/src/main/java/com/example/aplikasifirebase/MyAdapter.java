...
public class MyAdapter extends RecyclerView.Adapter {
    ...
    List<com.example.aplikasifirebase.Mahasiswa> fetcgDataList;
    private OnItemClickListener mListener;

    public MyAdapter(List<com.example.aplikasifirebase.Mahasiswa> fetcgDataList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        com.example.aplikasifirebase.Mahasiswa mahasiswa = fetcgDataList.get(position);
